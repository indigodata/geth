...
HOSTREGION=Europe
  ...
  (crontab -l 2>/dev/null; echo  "0 <6,18 local> * * * bash /home/ubuntu/cycle_peers.sh /node-b /node-b/ethereum ${HOSTREGION} >> /home/ubuntu/logs/cycle_peers.log 2>&1") | crontab - # Even days
